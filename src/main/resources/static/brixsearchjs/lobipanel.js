...
//------------------------------------------------------------------------------
        ...
        var _generateDropdown = function(){
            return $('<div class="dropdown lobipanelDropDown"></div>')
                    .append('<ul class="dropdown-menu dropdown-menu-right lobipanelDropDownList"></ul>')
                    .append('<div class="dropdown-toggle"><span class="'+LobiPanel.PRIVATE_OPTIONS.iconClass+' '+me.$options.toggleIcon+'"></div>');
        };
...
//                    bottom: $(window).height() - top - height + 2
        ...
        this.minimize = function(){
            ...
            if (me.isPinned()) {
                ...
                $($heading.find('[data-func="minimize"]')[0]).attr("data-original-title",'Maximize');
            } else {
                me.disableTooltips();
        ...
        this.maximize = function(){
            ...
            if (me.isPinned()){
                ...
                console.log( me.$el.find(".control-title").text());
                _saveState('pinned');
                _changeClassOfControl($heading.find('[data-func="minimize"]'));
                $($heading.find('[data-func="minimize"]')[0]).attr("data-original-title", "Minimize");
            }else{
                me.enableTooltips();
...
//            css['position'] = 'absolute';
        ...
        this.toFullScreen = function(){
            ...
            $($heading.find('[data-func="expand"]')[0]).attr("data-original-title","SmallScreen");
        ...
        this.toSmallSize = function(){
            ...
            _changeClassOfControl($heading.find('[data-func="expand"]'));
            $($heading.find('[data-func="expand"]')[0]).attr("data-original-title","Fullscreen");
            $heading.find('[data-func="expand"]').tooltip('hide');
            var css = me.$el.attr('old-style').getCss();
...
//------------------------------------------------------------------------------
    ...
    var actualScreenMaxHeight = screen.height - 150; // Added by kmira to get the actual screen height
    $.fn.lobiPanel.DEFAULTS = {
        ...
        maxHeight: actualScreenMaxHeight,
