...
! function(a, b) {
    function d(c, d) {
        ...
        if (g === b && (g = 0), 0 == g) {
            ...
            if (d.zIndex !== b && h.css("z-index", d.zIndex), d.image && h.css({
                ...
                }).appendTo(h), d.custom && a(d.custom).appendTo(h), e ? h.css({
                    position: "fixed",
                    top: 0,
                    left: 0,
                    width: "100%",
    ...
    function f(b, c, d, e) {
        ...
        var g = e ? a(window) : b,
            h = "auto";
        d.size && "auto" != d.size && (h = Math.min(g.innerWidth(), g.innerHeight()) * parseFloat(d.size) / 100, d.maxSize && h > parseInt(d.maxSize, 10) && (h = parseInt(d.maxSize, 10) + "px"), d.minSize && h < parseInt(d.minSize, 10) && (h = parseInt(d.minSize, 10) + "px")), c.css("background-size", h), c.children(".loadingoverlay_fontawesome").css("font-size", 50)
    }
    var c = {
